...
let registrar_padre = (pnombre, psegundoNombre, papellido, psegundoApellido, ptipoIdentificacion, pnumIdentificacion, pnacionalidad, pfechaNacimiento, pnumCel, pnumCasa, pEmail, pprovincia, pcanton, pdistrito, pdireccion, pcantidadHijos, pnombreHijo, pedadHijo, pnombreHijo2, pedadHijo2, pnombreHijo3, pedadHijo3, pnombreHijo4, pedadHijo4, pcontrasenna) => {
  let request = $.ajax({
      ...
      if (msg.success){
        swal.fire({
          ...
          onAfterClose: function () {
            window.location.replace('./validar_pin.html');
          }
        });
      } else {
        swal.fire({
